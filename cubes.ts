...
employeesCube = defineCube('Employees', {
  ...
  sql: (ctx: QueryContext): BaseQueryDefinition => ({
    from: employees,
    where: eq(employees.organisationId, (ctx.securityContext as any).organisationId)
  }),
...
departmentsCube = defineCube('Departments', {
  ...
  sql: (ctx: QueryContext): BaseQueryDefinition => ({
    from: departments,
    where: eq(departments.organisationId, (ctx.securityContext as any).organisationId)
  }),
...
productivityCube = defineCube('Productivity', {
  ...
  sql: (ctx: QueryContext): BaseQueryDefinition => ({
    from: productivity,  
    where: eq(productivity.organisationId, (ctx.securityContext as any).organisationId)
  }),
